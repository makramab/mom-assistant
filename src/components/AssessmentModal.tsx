          ...
          >
            <div className="bg-white rounded-2xl shadow-xl overflow-hidden">
              ...
              <div className="flex items-center justify-between px-6 py-4 border-b border-gray-100">
                <h2 className="text-xl font-semibold text-gray-900">Child Development Assessment</h2>
                <button
                  onClick={onClose}
                ...
                <div className="space-y-6">
                  ...
                  <div>
                    ...
                    <select className="w-full rounded-lg border-gray-200 focus:border-teal-500 focus:ring-teal-500">
                      ...
                      <option value="2-4m">2-4 months</option>
                  ...
                  <div className="space-y-4">
                    ...
                    <div className="grid gap-4 md:grid-cols-2">
                      <button className="flex items-center justify-between p-4 rounded-xl border-2 border-gray-200 hover:border-teal-500 transition-colors group">
                        <div className="flex items-center space-x-3">
                          <div className="w-10 h-10 rounded-full bg-teal-100 flex items-center justify-center group-hover:bg-teal-500 transition-colors">
                            <svg className="w-6 h-6 text-teal-500 group-hover:text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
